        ...
        a 37,37 0 1,1 -74,0"
              ...
              <text>
                <textPath href="#circle-menu" className="unselectable font-['Kanit']">
                  ...
                  <tspan
                    className={`cursor-pointer hover:opacity-100 transition-all ease-in-out duration-400 ${
                      marker === 1 ? "opacity-100" : "opacity-50"
                    }`}
                    onClick={() => setMarker(1)}
                  >
                    HElLO
                  ...
                  <tspan
                    className={`cursor-pointer hover:opacity-100 transition-all ease-in-out duration-400 ${
                      marker === 2 ? "opacity-100" : "opacity-50"
                    }`}
                    onClick={() => setMarker(2)}
                  >
                    ABOUT ME
                  ...
                  <tspan
                    className={`cursor-pointer hover:opacity-100 transition-all ease-in-out duration-400 ${
                      marker === 3 ? "opacity-100" : "opacity-50"
                    }`}
                    onClick={() => setMarker(3)}
                  >
                    PROJECTS
                  ...
                  <tspan
                    className={`cursor-pointer hover:opacity-100 transition-all ease-in-out duration-400 ${
                      marker === 4 ? "opacity-100" : "opacity-50"
                    }`}
                    onClick={() => setMarker(4)}
                  >
                    SKILLS
                  ...
                  <tspan
                    className={`cursor-pointer hover:opacity-100 transition-all ease-in-out duration-400 ${
                      marker === 5 ? "opacity-100" : "opacity-50"
                    }`}
                    onClick={() => setMarker(5)}
                  >
                    CONTACT
          ...
          <div
            className={`tall:w-[80vw] tall:h-[80vw] w-[80vw] h-[80vw] sm:w-[42vw]  sm:h-[42vw] wide:h-[83vh] wide:w-[83vh] border-2 ${
              marker >= 4 ? "border-[#00000060]" : "border-[#ffffff40]"
            } rounded-full relative transition-all ease-in-out duration-700`}
            style={circleStyle}
          >
            <div
              className={`w-2 h-2 md:w-3 md:h-3 2xl:w-5 2xl:h-5 ${
                marker >= 4 ? "bg-zinc-800" : "bg-zinc-200"
